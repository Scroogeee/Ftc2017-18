...
public class DriveControl4W {
	...
	public void initMotors() {
		Drive_A = mainRef.hardwareMap.dcMotor.get();
		Drive_B = mainRef.hardwareMap.dcMotor.get();
		Drive_C = mainRef.hardwareMap.dcMotor.get();
		Drive_D = mainRef.hardwareMap.dcMotor.get();
	}
