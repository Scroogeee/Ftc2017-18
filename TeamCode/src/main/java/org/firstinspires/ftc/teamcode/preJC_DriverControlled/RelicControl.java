...
import static org.firstinspires.ftc.teamcode.preJC_DriverControlled.Constants.RELIC_HEIGHT_SCALE;
...
public class RelicControl {
	...
	private void updateHeight() {
		height_motor.setPower(mainRef.gamepad2.left_stick_x* RELIC_HEIGHT_SCALE);
	}

	private void updateExtend() {
		extending_motor.setPower(mainRef.gamepad2.left_stick_y);
	}
